...
void blind_drive_until_front_found(float threshold, int base_speed)
{
...
void pid_drive_until_front_found(float threshold, int base_speed)
{
    ...
    while (true)
    {
        float left_distance = analogRead(left_ultra);
        float right_distance = analogRead(right_ultra);
        float front_distance = analogRead(front_ultra);
        if (front_distance < threshold)
        {
        ...
        // Clamp speeds within allowed limits
        leftMotorSpeed = constrain(leftMotorSpeed, 105, 255);
        rightMotorSpeed = constrain(rightMotorSpeed, 105, 255);
...
void hug_left_drive_until_front_found(float threshold, int base_speed)
{
    ...
    while (true)
    {
        ...
        // Calculate distance error between left and right sides
        float distance_error = 70 - left_distance;
...
void blind_drive_until_wall_found(int base_speed)
{
...
void pid_drive_until_wall_gone(int base_speed)
{
...
void pid_drive_hug_right(int base_speed)
{
    ...
    while (true)
    {
        ...
        // Calculate distance error between left and right sides
        float distance_error = right_distance - 70;
...
void pid_drive_hug_left(int base_speed)
{
    ...
    while (true)
    {
        float left_distance = analogRead(left_ultra); // Adjust with any necessary conversion
        float right_distance = analogRead(right_ultra);
        if (right_distance < 150 || left_distance > 150)
        {
            break;
        }
...
void blind_forward(int base_speed, int time)
{
    analogWrite(ENB, base_speed);
    analogWrite(ENA, base_speed);
    digitalWrite(IN3, HIGH); // Left motor forward
...
void one (){
    turn_left(155, 500);
    delay(300);
    pid_drive_until_wall_gone(155);
    delay(200);
    blind_forward(100,125);
    delay(500);
    uturn_right(155, 500, 150);
    delay(300);
    pid_drive_hug_left(155);
    delay(300);
    pid_drive_until_front_found(50,155);
}
void go_two(){
  turn_right(155, 500);
  delay(300);
...
void setup()
{
    ...
    delay(3000);
    pid_drive_until_wall_gone(125);
    delay(500);
    hug_left_drive_until_front_found(120, 105);
    delay(500);
    turn_right(105, 700);
    pid_drive_hug_left(105); 
    delay(100);
    pid_drive_until_wall_gone(105);
    delay(500);
    hug_left_drive_until_front_found(150, 105);
    delay(500);
    turn_right(105, 700);
    /*
    pid_drive_hug_left(155);
    ...
    delay(300);
    blind_drive_until_wall_found(155);
    delay(300);
    pid_drive_until_wall_gone(155);
    delay(100);
    blind_forward(100,125);
    ...
    blind_drive_until_wall_found(155);
    delay(300);
    blind_drive_until_front_found(200, 155);
    delay(500);
    turn_left(155, 500);
    delay(100);
    pid_drive_hug_right(155);
    delay(100);
    pid_drive_until_wall_gone(155);
    delay(100);
    blind_drive_until_front_found(200, 155);
